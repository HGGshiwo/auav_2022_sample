...
class Env(MavrosOffboardPosctl):
    ...
    def rover_pos_callback(self, msg):
        ...
        self.direction = rover - drone  # (2, ), altitude is compute independently
        direction = self.direction + self.actions[self.action]
    ...
    def get_obs(self):
        obs = np.zeros((10,))
        obs[0] = self.direction[0]
        obs[1] = self.direction[1]
